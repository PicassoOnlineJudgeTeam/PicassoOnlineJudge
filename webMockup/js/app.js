...
import List from './components/pages/List.react';
import Question from './components/pages/Question.react';
import Solve from './components/pages/Solve.react';
import Visualize from './components/pages/Visualize.react';
    ...
    <Router history={browserHistory}>
      <Route component={App}>
        ...
        <Route onEnter={checkAuth}>
          ...
          <Route path="/visualize/:source" component={Visualize} />
        </Route>
